...
## <a name='second-section'>2. Используйте let и const вместо var.</a>
...
## <a name='third-section'>3. Используйте понятные имена переменных и функций.</a>
...
```
## <a name='fourth-section'>4. Точка с запятой.</a>
...
alert('Мир');
```
## <a name='fifth-section'>5. Отступы.</a>
...
## <a name='sixth-section'>6. Пробелы.</a>
...
```
## <a name='seventh-section'>7. Фигурные скобки.</a>
...
```
## <a name='eighth-section'>8. Кавычки.</a>
...
```
## <a name='tenth-section'>10. Комментарии.</a>
